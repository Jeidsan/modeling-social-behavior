...
to setup
  ...
  ;; set our agents' shape as turtles
  ...
  ;; set initial values to collisions
  set collisions 0
...
to move
  right random whimsy ;;turn a random amount
  left random whimsy
...
"" ""
PENS
"# collisions" 1.0 0 -16777216 true "" "plot collisions"
"collisions by time" 1.0 0 -7500403 true "" "plot collisions / ticks"
